      ...
      <div className="sidebar__content">
        ...
        <ul className="sidebar__block">
          <SidebarCategory title="Manage store" icon="cart">
            <SidebarLink title="Products List" route="/store/products_list" onClick={this.hideSidebar} />
            <SidebarLink title="Transaction List" route="/store/orders_list" onClick={this.hideSidebar} />
